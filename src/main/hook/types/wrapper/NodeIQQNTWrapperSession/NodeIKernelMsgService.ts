...
export interface NodeIKernelMsgService {
  ...
  getMsgsIncludeSelf(filter: any): any[] // 获取包括自己在内的消息
  ...
  getRichMediaFilePathForGuild(guildId: string): string // 获取公会的富媒体文件路径
  ...
  fetchFavEmojiList(): any[] // 获取收藏表情列表
  ...
  grabRedBag(bagId: string): void // 抢红包
